...
class FaceGraphic extends GraphicOverlay.Graphic {
    ...
    public void draw(Canvas canvas) {
        ...
        // Draw the eyes.
        drawEye(newCanvas, leftEyePosition, eyeRadius, leftEyePosition, irisRadius, leftEyeOpen, smiling);
        drawEye(newCanvas, rightEyePosition, eyeRadius, rightEyePosition, irisRadius, rightEyeOpen, smiling);

        // Draw the nose.
        drawNose(newCanvas, noseBasePosition, leftEyePosition, rightEyePosition, width);

        // Draw the mustache.
        drawMustache(newCanvas, noseBasePosition, mouthLeftPosition, mouthRightPosition);
...
// Draw the hat only if the subject's head is titled at a sufficiently jaunty angle.
        ...
        if (Math.abs(eulerZ) > HEAD_TILT_HAT_THRESHOLD) {
            drawHat(newCanvas, position, width, height, noseBasePosition);
        }
